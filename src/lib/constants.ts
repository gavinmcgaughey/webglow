...
export const PROJECTS = [
  ...
  },
  {
    ...
    description: "Service-area pages, emergency CTAs, and review highlights designed to capture local search traffic and phone calls.",
  ...
  },
  {
    ...
    description: "Warm, trustworthy design with online scheduling and treatment pages that reduce phone tag and fill the calendar.",
